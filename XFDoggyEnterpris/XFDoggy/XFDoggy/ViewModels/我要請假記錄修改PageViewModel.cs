    ...
    public class 我要請假記錄修改PageViewModel : BindableBase, INavigationAware
    {
            ...
            IPageDialogService dialogService)
        {
            ...
            刪除按鈕Command = new DelegateCommand(async () =>
            {
                ...
                if (fooAnswer == true)
                {
                    var fooDelObj = foo請假紀錄Repository.請假紀錄.FirstOrDefault(x => x.ID == 請假紀錄項目.ID);
                    if (fooDelObj != null)
                    {
                        foo請假紀錄Repository.請假紀錄.Remove(fooDelObj);
                        await foo請假紀錄Repository.Write();
                    }
            ...
            儲存按鈕Command = new DelegateCommand(async () =>
            {
                ...
                {
                    foo請假紀錄Repository.請假紀錄.Add(new 請假紀錄項目
                    {
                ...
                else
                {
                    ...
                    if (fooDelObj != null)
                    {
                        fooDelObj.ID = 請假紀錄項目.ID;
                        fooDelObj.假別 = 點選假別;
                        fooDelObj.申請人 = "";
                        fooDelObj.請假日期 = 請假紀錄項目.請假日期;
                        fooDelObj.請假時數 = 請假紀錄項目.請假時數;
                        fooDelObj.請假理由 = 請假紀錄項目.請假理由;
                        fooDelObj.開始時間 = 請假紀錄項目.開始時間;
                        await foo請假紀錄Repository.Write();
                        await _navigationService.GoBackAsync();
                    }
                    else
