namespace XFWebAPI.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<XFWebAPI.DAL.DoggyContext>
    {
        public Configuration()
        {
            AutomaticMigrationsEnabled = false;
            ContextKey = "XFWebAPI.DAL.DoggyContext";
        }

        protected override void Seed(XFWebAPI.DAL.DoggyContext context)
        {
            #region 差旅類別紀錄初始化
